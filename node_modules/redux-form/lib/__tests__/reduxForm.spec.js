...
var describeReduxForm = function describeReduxForm(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should no resubmit if async submit is in progress', function () {
      ...
      var submitSpy = (0, _expect.createSpy)().andCall(function () {
    ...
    it('should delete submit promise when dispatching stopSubmit', function () {
      ...
      stub.submit();
      store.dispatch((0, _actions.stopSubmit)('testForm', {}));
      stub.submit();
    ...
    it('should allow sync validation for array props on push', function () {
      var store = makeStore({});
      var formRender = (0, _expect.createSpy)();
      var inputs = [(0, _expect.createSpy)(function (props) {
        return _react2.default.createElement('input', props.input);
      }).andCallThrough(), (0, _expect.createSpy)(function (props) {
        return _react2.default.createElement('input', props.input);
      }).andCallThrough(), (0, _expect.createSpy)(function (props) {
        return _react2.default.createElement('input', props.input);
      }).andCallThrough()];
      var renderArray = function renderArray(_ref4) {
        ...
        return _react2.default.createElement(
          ...
          fields.map(function (name, index) {
            return _react2.default.createElement(Field, { name: name, key: index, component: inputs[index] });
          })
        );
      };
