...
var describeFields = function describeFields(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should prefix name getter when inside FormSection', function () {
      ...
      var renderFields = function renderFields(_ref) {
        ...
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement('input', foo.input),
          _react2.default.createElement('input', bar.input)
        );
      };
        ...
        _createClass(Form, [{
          ...
          value: function render() {
            return _react2.default.createElement(
              ...
              { name: 'foo' },
              _react2.default.createElement(Fields, { names: ['foo', 'bar'], component: renderFields })
            );
          }
        }]);
    ...
    it('should rerender when one of the fields changes', function () {
      ...
      var inputPair1 = (0, _expect.createSpy)(function (_ref5) {
        var cat = _ref5.cat,
            dog = _ref5.dog;
        return _react2.default.createElement(
          'div',
      ...
      var inputPair2 = (0, _expect.createSpy)(function (_ref6) {
        var ewe = _ref6.ewe,
            fox = _ref6.fox;
        return _react2.default.createElement(
          'div',
        ...
        _createClass(Form, [{
          ...
          value: function render() {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(Fields, { names: ['name'], component: input })
            );
          }
        }]);
          ...
          value: function render() {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(Fields, {
                ...
                anotherCustomProp: 42,
                customBooleanFlag: true }),
              _react2.default.createElement('button', { type: 'button', onClick: this.changeNames })
            );
          }
        }]);
