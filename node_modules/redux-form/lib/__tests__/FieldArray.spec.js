...
var describeFieldArray = function describeFieldArray(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should prefix name when inside FormSection', function () {
      ...
      var props = _reactAddonsTestUtils2.default.findRenderedComponentWithType(dom, TestComponent).props;
    ...
    it('should not prefix name in fields map callback when inside FormSection', function () {
      ...
      var components = _reactAddonsTestUtils2.default.scryRenderedComponentsWithType(dom, TestComponent);
    ...
    it('should rerender when depending value has updated', function () {
      ...
      var checkbox = _reactAddonsTestUtils2.default.scryRenderedDOMComponentsWithTag(dom, 'input').find(function (element) {
        return element.getAttribute('name') === 'dogs[0].hasCollar';
      });

      _reactAddonsTestUtils2.default.Simulate.change(checkbox, { target: { value: true } });

      expect(_reactAddonsTestUtils2.default.scryRenderedDOMComponentsWithClass(dom, 'collar').length).toBe(1);

      _reactAddonsTestUtils2.default.Simulate.change(checkbox, { target: { value: false } });

      expect(_reactAddonsTestUtils2.default.scryRenderedDOMComponentsWithClass(dom, 'collar').length).toBe(0);
    });
