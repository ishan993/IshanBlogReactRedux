...
<html lang="en">
<head>
    <title>Code coverage report for react-dropzone/src/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">react-dropzone/src</a> index.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.69% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>127/130</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint prefer-template: 0 */
...
<span class="branch-1 cbranch-no" title="branch not covered" >  true;</span>
&nbsp;
...
&nbsp;
  onDragStart(e) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.onDragStart) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.dragTargets.length &gt; 0) {
  ...
  onFileDialogCancel() {
    ...
    if (onFileDialogCancel &amp;&amp; isFileDialogActive) {
      setTimeout(() =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!FileList.length) {
...
&nbsp;
    className = className || '';
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isDragActive &amp;&amp; activeClassName) {
<span class="cstat-no" title="statement not covered" >      className += ' ' + activeClassName;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isDragReject &amp;&amp; rejectClassName) {
<span class="cstat-no" title="statement not covered" >      className += ' ' + rejectClassName;</span>
    }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Apr 07 2017 16:25:38 GMT+0000 (UTC)
</div>
</div>
